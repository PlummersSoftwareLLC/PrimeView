...
At the moment, the application loads benchmark reports in JSON format, either from a configured location or using a default approach. More inforimation on how this works can be found in [JsonFileReader/README.md](src/JsonFileReader/README.md).
